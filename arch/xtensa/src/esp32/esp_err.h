/****************************************************************************
 * arch/xtensa/src/esp32/esp_err.h
 *
...
/**
 * Macro which can be used to check the error code. Prints the error code,
 * error location, and the failed statement to serial output.
 * In comparison with ESP_ERROR_CHECK(), this prints the same error message
 * but isn't terminating the program.
 */
