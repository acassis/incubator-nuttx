/****************************************************************************
 * boards/arm/rp2040/raspberry-pi-pico/src/rp2040_sx127x.c
 *
...
static int sx127x_irq0_attach(xcpt_t isr, void *arg)
{
  ...
  ret = rp2040_gpio_irq_attach(GPIO_SX127X_DIO0,
...
static void sx127x_chip_reset(void)
{
  ...
  rp2040_gpio_init(GPIO_SX127X_RESET);
  rp2040_gpio_setdir(GPIO_SX127X_RESET, true);

  /* Set pin to zero */

  rp2040_gpio_put(GPIO_SX127X_RESET, false);
  ...
  rp2040_gpio_put(GPIO_SX127X_RESET, true);
...
int rp2040_lpwaninitialize(void)
{
  ...
  rp2040_gpio_init(GPIO_SX127X_DIO0);

  /* Disable pull-up/down */

  rp2040_gpio_set_pulls(GPIO_SX127X_DIO0, false, false);

  /* Init SPI bus */

  spidev = rp2040_spibus_initialize(SX127X_SPI);
  if (!spidev)
    {
